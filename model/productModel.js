...
const setImageUrl = (doc) => {
    if (doc.imageCover) {
        ...
        const imageCoverUrl = `https://obnoxious-bernice-marwansalem-90080425.koyeb.app/products/${doc.imageCover}`;
    ...
    if (doc.images) {
        ...
        doc.images.forEach((image) => {
            ...
            const imageUrl = `https://obnoxious-bernice-marwansalem-90080425.koyeb.app/products/${image}`;
